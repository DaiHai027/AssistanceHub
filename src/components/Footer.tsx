...
import { Home, Utensils, Shield, MapPin, Phone, Mail, ExternalLink, Star, Sparkles, Heart, ChevronRight, Globe, Users, Clock, Zap } from 'lucide-react';
import { Button } from '@/components/ui/button';

const Footer = () => {
  const quickLinks = [
    { name: 'Section 8 Housing', href: '/section8', icon: Home, description: 'Find housing assistance' },
    { name: 'SNAP Benefits', href: '/snap', icon: Utensils, description: 'Food assistance programs' },
  ...
  const resources = [
    ...
    { name: 'SNAP Application Guide', href: '#', external: false },
    ...
    { name: 'SNAP Official Site', href: 'https://www.fns.usda.gov/snap', external: true }
  ];
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-xl border border-white/10 px-6 py-3 rounded-full text-sm font-semibold mb-6">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="font-semibold text-purple-300"> Fast, free, and designed to help you succeed.</span>
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 shadow-2xl group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                ...
                <Button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-3 rounded-xl shadow-2xl transition-all duration-300 transform hover:scale-105 border-0">
        ...
        <div className="border-t border-white/10 pt-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <div className="text-xl font-black text-white">AssistanceHub</div>
